...
На проверенных участниках (реестр составляетяс создателем) не распространяются ограничения по кулдану и запрещённым словам 

Требования к проверенному участнику:
- Не получать варн на протяжении недели (если варн выдаётся, участник снимается из списка)
- 
